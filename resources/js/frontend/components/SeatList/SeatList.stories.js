...
const paddedList = () => {
    return {
        template: `<div style="display: flex; justify-content:center; flex-wrap: wrap; margin: 16px; padding: 16px; border: 1px solid #000;"><story/></div>`
    };
};
...
const template = `
    <div>
        <p>normal</p>
        <div style="display: flex; justify-content:center; max-width: 270px; margin: 16px; padding: 16px; background-color: #FFFFFF;  border: 1px solid #000;">
            <SeatList :theme="'normal'" :seats="seats"/>
        </div>
        <p>theme-gameuser</p>
        <div style="display: flex; justify-content:center; max-width: 270px; margin: 16px; padding: 16px; background-color: #1E1F4A; border: 1px solid #000;">
